...
public class StringBilderEx {
    public static void main(String[] args) {
        // String 원본 문자열 불가이기 때문에 매번 기존메모리를 해제하고 재생성
        String str1 = "안녕하세요";
        str1 += "반갑습니다";
        str1 += "저는 홍길동입니다.";

        // StringBuffer sb = new "안녕하세요"; (x)
        ...
        // StringBuffer equals 확인 - 부모가 상속해준 그대로 사용함
        StringBuffer sb1 = new StringBuffer("Hello");
        StringBuffer sb2 = new StringBuffer("Hello");
        System.out.println(sb1.equals(sb2) ? "문자열 같음" : "문자열 다름");

        // String equals 사용하기 위한 변환
        ...
        System.out.println("sb1.delete(0) " + sb1.deleteCharAt(0));
