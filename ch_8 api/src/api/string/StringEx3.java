...
public class StringEx3 {
    public static void main(String[] args) {
        ...
        System.out.println(str.replaceAll("[a-z]", "1")); // 안녕하세요W1111
        ...
        System.out.println("특정위치의 문자열 얻기" + str2.substring(10)); // Object
        // 끝 위치는 포함하지 않음
        System.out.println("특정위치의 문자열 얻기" + str2.substring(5, 9)); // Object
